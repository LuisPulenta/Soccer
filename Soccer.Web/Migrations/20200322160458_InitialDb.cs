    ...
    public partial class InitialDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DateNames", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DateNames_Tournaments_TournamentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupId = table.Column<int>(nullable: true),
                    DateNameId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Matches", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Matches_DateNames_DateNameId",
                        column: x => x.DateNameId,
                        principalTable: "DateNames",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GroupBets_Players_AdminId",
                        column: x => x.AdminId,
                        principalTable: "Players",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GroupBets_Tournaments_TournamentId",
                        column: x => x.TournamentId,
                        principalTable: "Tournaments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "GroupBetPlayers",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    GroupBetId = table.Column<int>(nullable: true),
                    PlayerId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupBetPlayers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GroupBetPlayers_GroupBets_GroupBetId",
                        column: x => x.GroupBetId,
                        principalTable: "GroupBets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GroupBetPlayers_Players_PlayerId",
                        column: x => x.PlayerId,
                        principalTable: "Players",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DateNames_TournamentId",
                table: "DateNames",
                column: "TournamentId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupBetPlayers_GroupBetId",
                table: "GroupBetPlayers",
                column: "GroupBetId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupBetPlayers_PlayerId",
                table: "GroupBetPlayers",
                column: "PlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupBets_AdminId",
                table: "GroupBets",
                column: "AdminId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupBets_TournamentId",
                table: "GroupBets",
                column: "TournamentId");
