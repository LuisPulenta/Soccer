...
namespace Soccer.Web.Migrations
{
    public partial class InitialDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "PlayerGroupBetRequests",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ProposalPlayerId = table.Column<int>(nullable: true),
                    RequiredPlayerId = table.Column<int>(nullable: true),
                    GroupBetId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlayerGroupBetRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlayerGroupBetRequests_GroupBets_GroupBetId",
                        column: x => x.GroupBetId,
                        principalTable: "GroupBets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PlayerGroupBetRequests_Players_ProposalPlayerId",
                        column: x => x.ProposalPlayerId,
                        principalTable: "Players",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PlayerGroupBetRequests_Players_RequiredPlayerId",
                        column: x => x.RequiredPlayerId,
                        principalTable: "Players",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlayerGroupBetRequests_GroupBetId",
                table: "PlayerGroupBetRequests",
                column: "GroupBetId");

            migrationBuilder.CreateIndex(
                name: "IX_PlayerGroupBetRequests_ProposalPlayerId",
                table: "PlayerGroupBetRequests",
                column: "ProposalPlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_PlayerGroupBetRequests_RequiredPlayerId",
                table: "PlayerGroupBetRequests",
                column: "RequiredPlayerId");
